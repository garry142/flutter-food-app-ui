...
import 'package:food_app_ui/items_details.dart';
import 'package:food_app_ui/model/items_model.dart';
import 'package:food_app_ui/utils/colors.dart';

class ItemsDiplay extends StatefulWidget {
  const ItemsDiplay({super.key});

  @override
  State<ItemsDiplay> createState() => _HomepageState();
}

class _HomepageState extends State<ItemsDiplay> {
  @override
